...
class ConvertVideoScreen extends StatefulWidget {
  ...
  const ConvertVideoScreen({Key? key, required this.imageUrl})
      : super(key: key);
...
class _ConvertVideoScreenState extends State<ConvertVideoScreen> {
  ...
  String baseUrl =
      "https://res.cloudinary.com/dyeo7dpua/image/upload/c_scale,w_500,q_35,f_auto/";
  @override
                  ...
                  onPressed: selectedQuality == null
                      ...
                      : () {
                          String updatedUrl = fullImageUrl.replaceFirst(
                            RegExp(r'w_\d+'),
                            'w_${selectedQuality == '1080p' ? '1920' : selectedQuality == '720p' ? '1280' : '854'}',
                          );
